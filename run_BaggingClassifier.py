...
from sklearn.ensemble import BaggingClassifier #under different roof .ensemble, 
...
for training_index, test_index in kfold_object.split(data):
	...
	machine = BaggingClassifier(n_estimators=11) #copy, paste and adapt from kfold #try different max_depth = 10 , 30, 3
